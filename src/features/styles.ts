...
body {
                background-color: #e8d3a6 !important;
                font-family: var(--hsguru-font-sans) !important;
            ...
            .hsguru-sidebar-title {
                font-family: var(--hsguru-font-serif) !important;
                font-weight: 500 !important;
            }
            #main-navbar {
                backdrop-filter: blur(20px) !important;
                background-color: rgba(60, 42, 41, .8) !important;
            }
            .card {
                border: 2px solid #585049 !important;
                outline: 3px solid #342e2a !important;
                background-color: #3e3630 !important;
                margin: 0 auto !important;
            }
            .card:hover {
                border: 2px solid #70aff7 !important;
                outline: 3px solid #c7ffff !important;
                box-shadow: inset 0 0 20px rgba(78, 185, 230, 0.8),
                           inset 0 0 35px rgba(0, 149, 255, 0.6) !important;
            }
...
.filters-container {
                ...
                min-height: 0 !important;
                 ...
                 padding: 30px 24px 30px clamp(24px, 7vw, 100px);
                 row-gap: 10px !important;
                 overflow: visible !important;
             }
             .filters-container[data-hsguru-nested-filter-container="true"] {
             ...
             .columns.is-multiline .column:has(.hsguru-deck-detail-filters) {
                 height: auto !important;
                 min-height: 0 !important;
                 overflow: visible !important;
             }
            ...
            .svg-container:has(svg) svg {
                display: block;
                width: 100%;
                height: auto;
                background: transparent !important;
            }
            .svg-container:has(svg) svg text {
                fill: #4a3217 !important;
                font-family: var(--hsguru-font-sans);
                font-size: 12px;
            }
            .svg-container:has(svg) svg path,
            .svg-container:has(svg) svg line {
                stroke: rgba(86, 59, 28, 0.7) !important;
            }
            .svg-container:has(svg) svg circle {
            ...
            .filters-container [x-data].tw-border-orange-500 {
                border-color: #8d7658 !important;
                border-radius: 22px !important;
                box-shadow: 0 0 0 2px rgba(255, 255, 149, 0.55), 0 4px 10px rgba(98, 67, 28, 0.28) !important;
            }
            .filters-container [x-data].tw-border-orange-500 > a.button {
                background-color: #ffff95 !important;
                border-color: #8d7658 !important;
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.62), 0 2px 5px rgba(98, 67, 28, 0.24) !important;
            }
            ...
            .chart-container [phx-hook="ChartJs"] {
                width: 100%;
                min-height: 400px;
            }
            .chart-container canvas {
                ...
                margin: 0 auto;
                border: 1px solid rgba(107, 86, 52, 0.35);
                border-radius: 10px;
                background: rgba(239, 232, 214, 0.88) !important;
                box-shadow: inset 0 1px 2px rgba(34, 23, 13, 0.16);
                box-sizing: border-box;
            }
            .class-icon {
...
.table {
        ...
        .content table thead td, .content table thead th, .table thead td, .table thead th {
            ...
            color: #614326 !important;
            background-color:#e8d3a6 !important;
            border-bottom: 2px solid #caae85 !important;
        }
            ...
            background-image: linear-gradient(0deg, var(--hsguru-class-bg, rgba(154, 135, 104, 0.10)), var(--hsguru-class-bg, rgba(154, 135, 104, 0.10))) !important;
...
export function injectStyles(config?: Record<string, boolean>): void {
  const styleModules: Record<string, string> = {
    TABLE_STYLE: isFeatureEnabled('TABLE_STYLE', config) ? tableStyles : '',
    UI: isFeatureEnabled('UI', config) ? uiStyles : '',
    FILTER_STYLE: isFeatureEnabled('FILTER_STYLE', config) ? filterStyles : '',
    MANA: isFeatureEnabled('MANA', config) ? manaStyles : '',
    AD: isFeatureEnabled('AD', config) ? adStyles : '',
    TITLE_STYLE: isFeatureEnabled('TITLE_STYLE', config) ? titleStyles : '',
    SUB_STYLE: isFeatureEnabled('SUB_STYLE', config) ? subStyles : '',
    RUNE: isFeatureEnabled('RUNE', config) ? runeStyles : '',
  };

  const enabledStyles = Object.values(styleModules).filter(Boolean).join('\n');
  const styleId = 'hsguru-chinese-plus-main-style';
